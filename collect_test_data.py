    ...
    for threads_num in threads_num_list:
        for iter_1 in iter_1_list:
            for iter_2 in iter_2_list:
                for all_iter in range(collect_data_iterations):
                    pass
                    ...
                    rf_time = time_prediction_rf[0]
                    svr_time = time_prediction_svr[0]
                    dtr_time = time_prediction_dtr[0]
                    lr_time = time_prediction_lr[0]
                    real_req_num = finish_val - start_val - 1

                    # ['threads', 'iter_1', 'iter_2', 'real_time', 'rf_time', 'svr_time', 'dtr_time', 'lr_time', 'real_req_num']
